...
describe("S256Point", () => {
  ...
  describe("sec", () => {
    describe("uncompressed", () => {
      const tests: [PrivateKey, Buffer][] = [
        [
          new PrivateKey(5000n),
        ...
        [
          new PrivateKey(BigInt("0xdeadbeef12345")),
