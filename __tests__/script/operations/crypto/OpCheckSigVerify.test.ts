...
import { opCheckSigVerify } from "../../../../src/script/operations/crypto/OpCheckSigVerify";
...
describe("Operation: opCheckSigVerifyVerify", () => {
  testStackLen(opCheckSigVerify, 2, Buffer.alloc(65));

  it("returns true when sig verifies", () => {
    ...
    expect(opCheckSigVerify(stack, z)).to.equal(true);
  });

  it("returns false when invalid pubkey format", () => {
    ...
    expect(opCheckSigVerify(stack, z)).to.equal(false);
  });

  it("returns false when invalid signature format", () => {
    const point = new S256Point(
      BigInt("0x887387e452b8eacc4acfde10d9aaf7f6d9a0f975aabb10d006e4da568744d06c"),
      BigInt("0x61de6d95231cd89026e286df3b6ae4a894a3378e393e93a0f45b666329a0ae34"),
    ); // prettier-ignore
  ...
  it("returns false when invalid signature", () => {
    const point = new S256Point(
      BigInt("0x887387e452b8eacc4acfde10d9aaf7f6d9a0f975aabb10d006e4da568744d06c"),
      BigInt("0x61de6d95231cd89026e286df3b6ae4a894a3378e393e93a0f45b666329a0ae34"),
    ); // prettier-ignore
